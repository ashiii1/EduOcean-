...
//         <div className="container mx-auto p-6">
//           <h2 className="text-black text-2xl mb-4">click on create course to add your course</h2>
//           {teacherData.courses.length === 0 ? (
//             <p className="text-black">No courses yet created.</p>
//           ) : (
//             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
...
const TeacherLand = () => {
  ...
  return (
    <div className="flex">
      {sidebarVisible && (
        <div className="fixed inset-0 z-10 bg-black opacity-50" onClick={() => setSidebarVisible(false)}></div>
      )}
      <TeacherSidebar sidebarVisible={sidebarVisible} setSidebarVisible={setSidebarVisible} />
      <div className={`flex-1 ${sidebarVisible ? 'ml-64' : ''} bg-cover bg-center min-h-screen`} style={{ backgroundImage: `url('')` }}>
        <nav className="bg-gray-800 p-4 flex items-center justify-between">
          <button
