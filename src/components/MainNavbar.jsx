...
const MainNavbar = () => {
  ...
  return (
    <>
      <button
        className="md:hidden p-2 text-white bg-gray-800 fixed top-2 left-2 z-50"
        onClick={handleToggleSidebar}
      >
        📓
      </button>
      <aside
        className={`bg-gray-800 text-white p-4 md:w-64 h-screen fixed left-0 top-0 overflow-y-auto transform transition-transform duration-300 ease-in-out z-40 ${
